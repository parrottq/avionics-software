 ...
 * @see https://www.seagate.com/files/staticfiles/support/docs/manual/Interface%20manuals/100293068j.pdf
 */
typedef struct scsi_command_descriptor_block_6
{
    /* Opcode */
    uint8_t opcode;
    /* Additional options */
 ...
 * @see https://www.seagate.com/files/staticfiles/support/docs/manual/Interface%20manuals/100293068j.pdf
 */
typedef struct scsi_command_descriptor_block_10
{
    /* Opcode */
    uint8_t opcode;
    /* Additional options */
 ...
 * @see https://www.seagate.com/files/staticfiles/support/docs/manual/Interface%20manuals/100293068j.pdf
 */
typedef struct scsi_command_descriptor_block_12
{
    /* Opcode */
    uint8_t opcode;
    /* Additional options */
 ...
 * @see https://www.seagate.com/files/staticfiles/support/docs/manual/Interface%20manuals/100293068j.pdf
 */
typedef struct scsi_command_descriptor_block_16
{
    /* Opcode */
    uint8_t opcode;
    /* Additional options */
